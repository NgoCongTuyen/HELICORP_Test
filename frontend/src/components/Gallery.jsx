    ...
    <section className="section gallery-section">
      ...
      <div className="gallery-grid">
        <article className="gallery-card">
          <img className="gallery-media" src="/images/thietke.png" alt="Thiết kế Titanium" />
        ...
        <article className="gallery-card">
          <img className="gallery-media" src="/images/camera.png" alt="Camera Fusion" />
        ...
        <article className="gallery-card">
          <img className="gallery-media" src="/images/manhinh.png" alt="Màn hình Super Retina" />
